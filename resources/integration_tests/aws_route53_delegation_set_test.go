...
func TestIntegrationRoute53DelegationSet(t *testing.T) {
	awsTestIntegrationHelper(t, resources.Route53ReusableDelegationSets(), func(res *providertest.ResourceIntegrationTestData) providertest.ResourceIntegrationVerification {
