	...
	return &schema.Table{
		...
		Columns: []schema.Column{
			...
			},
			{
				...
				TerraformResolver: schema.PathResolver("cpu_core_count"),
			},
			{
				...
				TerraformResolver: schema.PathResolver("cpu_threads_per_core"),
			},
			{
				Name:        "ebs_optimized",
			...
			},
			{
				...
				TerraformResolver: schema.PathResolver("enclave_options.0.enabled"),
			},
			{
				...
				TerraformResolver: schema.PathResolver("hibernation"),
			},
			{
				Name:        "hypervisor",
			...
			},
			{
				...
				Type:              schema.TypeString,
				TerraformResolver: schema.PathResolver("private_ip"),
			},
			{
			...
			},
			{
				...
				Type:              schema.TypeString,
				IgnoreInTests:     true,
				TerraformResolver: schema.PathResolver("public_ip"),
			},
			{
				Name:          "ramdisk_id",
