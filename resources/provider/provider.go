...
func Provider() *provider.Provider {
	return &provider.Provider{
		...
		ResourceMap: map[string]*schema.Table{
			...
			"iam.groups_access_advisor_details":     iam.GroupsAccessAdvisorDetails(),
			...
			"iam.policies_access_advisor_details":   iam.PoliciesAccessAdvisorDetails(),
			"iam.roles":                             iam.IamRoles(),
			"iam.roles_access_advisor_details":      iam.RolesAccessAdvisorDetails(),
			...
			"iam.users_access_advisor_details":      iam.UsersAccessAdvisorDetails(),
