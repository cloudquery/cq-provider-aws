-- Autogenerated by migration tool on 2022-01-11 20:07:21
...
CREATE TABLE IF NOT EXISTS "aws_access_analyzer_analyzer_findings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"analyzer_cq_id" uuid REFERENCES aws_access_analyzer_analyzers(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_access_analyzer_analyzer_finding_sources" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"analyzer_finding_cq_id" uuid REFERENCES aws_access_analyzer_analyzer_findings(cq_id) ON DELETE CASCADE,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigateway_domain_name_base_path_mappings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"domain_name_cq_id" uuid REFERENCES aws_apigateway_domain_names(cq_id) ON DELETE CASCADE,
	"domain_name" text,
	"base_path" text,
	"rest_api_id" text,
	"stage" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigateway_rest_api_authorizers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"rest_api_cq_id" uuid REFERENCES aws_apigateway_rest_apis(cq_id) ON DELETE CASCADE,
	"rest_api_id" text,
	"auth_type" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigateway_usage_plan_api_stages" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"usage_plan_cq_id" uuid REFERENCES aws_apigateway_usage_plans(cq_id) ON DELETE CASCADE,
	"usage_plan_id" text,
	"api_id" text,
	"stage" text,
	"throttle" jsonb,
...
CREATE TABLE IF NOT EXISTS "aws_apigatewayv2_api_authorizers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"api_cq_id" uuid REFERENCES aws_apigatewayv2_apis(cq_id) ON DELETE CASCADE,
	"api_id" text,
	"name" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigatewayv2_api_integration_responses" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"api_integration_cq_id" uuid REFERENCES aws_apigatewayv2_api_integrations(cq_id) ON DELETE CASCADE,
	"integration_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigatewayv2_api_route_responses" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"api_route_cq_id" uuid REFERENCES aws_apigatewayv2_api_routes(cq_id) ON DELETE CASCADE,
	"route_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_apigatewayv2_domain_name_configurations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"domain_name_cq_id" uuid REFERENCES aws_apigatewayv2_domain_names(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_autoscaling_group_instances" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"group_cq_id" uuid REFERENCES aws_autoscaling_groups(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_autoscaling_launch_configuration_block_device_mappings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"launch_configuration_cq_id" uuid REFERENCES aws_autoscaling_launch_configurations(cq_id) ON DELETE CASCADE,
	"device_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_cloudfront_distribution_default_cache_behavior_functions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"distribution_cq_id" uuid REFERENCES aws_cloudfront_distributions(cq_id) ON DELETE CASCADE,
	"event_type" text,
...
CREATE TABLE IF NOT EXISTS "aws_cloudfront_distribution_cache_behavior_lambda_functions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"distribution_cache_behavior_cq_id" uuid REFERENCES aws_cloudfront_distribution_cache_behaviors(cq_id) ON DELETE CASCADE,
	"event_type" text,
	"lambda_function_arn" text,
	"include_body" boolean,
...
CREATE TABLE IF NOT EXISTS "aws_cloudtrail_trail_event_selectors" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"trail_cq_id" uuid REFERENCES aws_cloudtrail_trails(cq_id) ON DELETE CASCADE,
	"trail_arn" text,
...
CREATE TABLE IF NOT EXISTS "aws_cloudwatch_alarm_metrics" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"alarm_cq_id" uuid REFERENCES aws_cloudwatch_alarms(cq_id) ON DELETE CASCADE,
	"alarm_arn" text,
	"alarm_name" text,
	"id" text,
	"expression" text,
...
CREATE TABLE IF NOT EXISTS "aws_cloudwatchlogs_filter_metric_transformations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"filter_cq_id" uuid REFERENCES aws_cloudwatchlogs_filters(cq_id) ON DELETE CASCADE,
	"metric_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_codebuild_project_environment_variables" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"project_cq_id" uuid REFERENCES aws_codebuild_projects(cq_id) ON DELETE CASCADE,
	"name" text,
	"value" text,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_cognito_identity_pool_cognito_identity_providers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"identity_pool_cq_id" uuid REFERENCES aws_cognito_identity_pools(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_cognito_user_pool_schema_attributes" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"user_pool_cq_id" uuid REFERENCES aws_cognito_user_pools(cq_id) ON DELETE CASCADE,
	"user_pool_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_dax_cluster_nodes" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_cq_id" uuid REFERENCES aws_dax_clusters(cq_id) ON DELETE CASCADE,
	"availability_zone" text,
...
CREATE TABLE IF NOT EXISTS "aws_directconnect_connection_mac_sec_keys" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"connection_cq_id" uuid REFERENCES aws_directconnect_connections(cq_id) ON DELETE CASCADE,
	"connection_id" text,
	"ckn" text,
	"secret_arn" text,
	"start_on" text,
...
CREATE TABLE IF NOT EXISTS "aws_directconnect_gateway_associations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"gateway_cq_id" uuid REFERENCES aws_directconnect_gateways(cq_id) ON DELETE CASCADE,
	"gateway_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_directconnect_lag_mac_sec_keys" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"lag_cq_id" uuid REFERENCES aws_directconnect_lags(cq_id) ON DELETE CASCADE,
	"lag_id" text,
	"ckn" text,
	"secret_arn" text,
	"start_on" text,
...
CREATE TABLE IF NOT EXISTS "aws_directconnect_virtual_interface_bgp_peers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"virtual_interface_cq_id" uuid REFERENCES aws_directconnect_virtual_interfaces(cq_id) ON DELETE CASCADE,
	"virtual_interface_id" text,
	"address_family" text,
	"amazon_address" text,
	"asn" integer,
...
CREATE TABLE IF NOT EXISTS "aws_dms_replication_instance_replication_subnet_group_subnets" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"replication_instance_cq_id" uuid REFERENCES aws_dms_replication_instances(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_dynamodb_table_global_secondary_indexes" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"table_cq_id" uuid REFERENCES aws_dynamodb_tables(cq_id) ON DELETE CASCADE,
	"backfilling" boolean,
	"arn" text,
	"name" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_ebs_volume_attachments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"ebs_volume_cq_id" uuid REFERENCES aws_ec2_ebs_volumes(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_image_block_device_mappings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"image_cq_id" uuid REFERENCES aws_ec2_images(cq_id) ON DELETE CASCADE,
	"device_name" text,
	"ebs_delete_on_termination" boolean,
	"ebs_encrypted" boolean,
	"ebs_iops" integer,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_instance_block_device_mappings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"instance_cq_id" uuid REFERENCES aws_ec2_instances(cq_id) ON DELETE CASCADE,
	"device_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_instance_network_interface_groups" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"instance_network_interface_cq_id" uuid REFERENCES aws_ec2_instance_network_interfaces(cq_id) ON DELETE CASCADE,
	"network_interface_id" text,
	"group_id" text,
	"group_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_internet_gateway_attachments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"internet_gateway_cq_id" uuid REFERENCES aws_ec2_internet_gateways(cq_id) ON DELETE CASCADE,
	"state" text,
	"vpc_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_nat_gateway_addresses" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"nat_gateway_cq_id" uuid REFERENCES aws_ec2_nat_gateways(cq_id) ON DELETE CASCADE,
	"allocation_id" text,
	"network_interface_id" text,
	"private_ip" text,
	"public_ip" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_network_acl_associations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"network_acl_cq_id" uuid REFERENCES aws_ec2_network_acls(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_route_table_associations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"route_table_cq_id" uuid REFERENCES aws_ec2_route_tables(cq_id) ON DELETE CASCADE,
	"id" text,
	"association_state" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_security_group_ip_permissions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"security_group_cq_id" uuid REFERENCES aws_ec2_security_groups(cq_id) ON DELETE CASCADE,
	"from_port" integer,
	"ip_protocol" text,
	"to_port" integer,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_security_group_ip_permission_ip_ranges" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"security_group_ip_permission_cq_id" uuid REFERENCES aws_ec2_security_group_ip_permissions(cq_id) ON DELETE CASCADE,
	"cidr_ip" text,
	"description" text,
	CONSTRAINT aws_ec2_security_group_ip_permission_ip_ranges_pk PRIMARY KEY(security_group_ip_permission_cq_id,cidr_ip),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "aws_ec2_security_group_ip_permissions_egress_ip_ranges" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"security_group_ip_permissions_egress_cq_id" uuid REFERENCES aws_ec2_security_group_ip_permissions_egresses(cq_id) ON DELETE CASCADE,
	"cidr_ip" text,
	"description" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_subnet_ipv6_cidr_block_association_sets" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"subnet_cq_id" uuid REFERENCES aws_ec2_subnets(cq_id) ON DELETE CASCADE,
	"association_id" text,
	"ipv6_cidr_block" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_transit_gateway_attachments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"transit_gateway_cq_id" uuid REFERENCES aws_ec2_transit_gateways(cq_id) ON DELETE CASCADE,
	"association_state" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_vpc_endpoint_dns_entries" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"vpc_endpoint_cq_id" uuid REFERENCES aws_ec2_vpc_endpoints(cq_id) ON DELETE CASCADE,
	"dns_name" text,
	"hosted_zone_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_vpc_cidr_block_association_sets" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"vpc_cq_id" uuid REFERENCES aws_ec2_vpcs(cq_id) ON DELETE CASCADE,
	"association_id" text,
	"cidr_block" text,
...
CREATE TABLE IF NOT EXISTS "aws_ec2_vpc_attachment" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"vpn_gateway_cq_id" uuid REFERENCES aws_ec2_vpn_gateways(cq_id) ON DELETE CASCADE,
	"state" text,
	"vpc_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_ecr_repository_images" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"repository_cq_id" uuid REFERENCES aws_ecr_repositories(cq_id) ON DELETE CASCADE,
	"account_id" text,
	"region" text,
...
CREATE TABLE IF NOT EXISTS "aws_ecs_cluster_attachments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_cq_id" uuid REFERENCES aws_ecs_clusters(cq_id) ON DELETE CASCADE,
	"details" jsonb,
	"id" text,
	"status" text,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_ecs_cluster_service_deployments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_service_cq_id" uuid REFERENCES aws_ecs_cluster_services(cq_id) ON DELETE CASCADE,
	"capacity_provider_strategy" jsonb,
	"created_at" timestamp without time zone,
	"desired_count" integer,
...
CREATE TABLE IF NOT EXISTS "aws_ecs_cluster_service_task_set_load_balancers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_service_task_set_cq_id" uuid REFERENCES aws_ecs_cluster_service_task_sets(cq_id) ON DELETE CASCADE,
	"container_name" text,
	"container_port" integer,
	"load_balancer_name" text,
	"target_group_arn" text,
...
CREATE TABLE IF NOT EXISTS "aws_ecs_cluster_container_instance_attachments" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_container_instance_cq_id" uuid REFERENCES aws_ecs_cluster_container_instances(cq_id) ON DELETE CASCADE,
	"details" jsonb,
	"id" text,
	"status" text,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_ecs_task_definition_container_definitions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"task_definition_cq_id" uuid REFERENCES aws_ecs_task_definitions(cq_id) ON DELETE CASCADE,
	"command" text[],
	"cpu" integer,
	"depends_on" jsonb,
...
CREATE TABLE IF NOT EXISTS "aws_eks_cluster_encryption_configs" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_cq_id" uuid REFERENCES aws_eks_clusters(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_elasticbeanstalk_configuration_settings" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"environment_cq_id" uuid REFERENCES aws_elasticbeanstalk_environments(cq_id) ON DELETE CASCADE,
	"application_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_elasticbeanstalk_configuration_setting_options" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"configuration_setting_cq_id" uuid REFERENCES aws_elasticbeanstalk_configuration_settings(cq_id) ON DELETE CASCADE,
	"namespace" text,
	"option_name" text,
	"resource_name" text,
	"value" text,
...
CREATE TABLE IF NOT EXISTS "aws_elbv1_load_balancer_backend_server_descriptions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"load_balancer_cq_id" uuid REFERENCES aws_elbv1_load_balancers(cq_id) ON DELETE CASCADE,
	"name" text,
...
CREATE TABLE IF NOT EXISTS "aws_elbv2_listeners" (
	...
	"account_id" text,
	"region" text,
	"load_balancer_cq_id" uuid REFERENCES aws_elbv2_load_balancers(cq_id) ON DELETE CASCADE,
	"tags" jsonb,
	"alpn_policy" text[],
	"arn" text,
...
CREATE TABLE IF NOT EXISTS "aws_elbv2_listener_certificates" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"listener_cq_id" uuid REFERENCES aws_elbv2_listeners(cq_id) ON DELETE CASCADE,
	"certificate_arn" text,
	"is_default" boolean,
...
CREATE TABLE IF NOT EXISTS "aws_elbv2_listener_default_action_forward_config_target_groups" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"listener_default_action_cq_id" uuid REFERENCES aws_elbv2_listener_default_actions(cq_id) ON DELETE CASCADE,
	"target_group_arn" text,
	"weight" integer,
...
CREATE TABLE IF NOT EXISTS "aws_elbv2_load_balancer_availability_zone_addresses" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"load_balancer_availability_zone_cq_id" uuid REFERENCES aws_elbv2_load_balancer_availability_zones(cq_id) ON DELETE CASCADE,
	"zone_name" text,
	"allocation_id" text,
	"ipv6_address" text,
	"ip_address" text,
...
CREATE TABLE IF NOT EXISTS "aws_emr_block_public_access_config_port_ranges" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"block_public_access_config_cq_id" uuid REFERENCES aws_emr_block_public_access_configs(cq_id) ON DELETE CASCADE,
	"min_range" integer,
	"max_range" integer,
...
CREATE TABLE IF NOT EXISTS "aws_guardduty_detector_members" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"detector_cq_id" uuid REFERENCES aws_guardduty_detectors(cq_id) ON DELETE CASCADE,
	"account_id" text,
	"email" text,
	"master_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_iam_group_policies" (
	...
	"cq_meta" jsonb,
	"account_id" text,
	"group_cq_id" uuid REFERENCES aws_iam_groups(cq_id) ON DELETE CASCADE,
	"group_id" text,
	"group_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_iam_policy_versions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"policy_cq_id" uuid REFERENCES aws_iam_policies(cq_id) ON DELETE CASCADE,
	"policy_id" text,
	"create_date" timestamp without time zone,
	"document" jsonb,
...
CREATE TABLE IF NOT EXISTS "aws_iam_role_policies" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"role_cq_id" uuid REFERENCES aws_iam_roles(cq_id) ON DELETE CASCADE,
	"role_id" text,
	"account_id" text,
	"policy_document" jsonb,
	"policy_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_iam_user_access_keys" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"user_cq_id" uuid REFERENCES aws_iam_users(cq_id) ON DELETE CASCADE,
	"user_id" text,
	"access_key_id" text,
	"create_date" timestamp without time zone,
	"status" text,
...
CREATE TABLE IF NOT EXISTS "aws_lambda_function_file_system_configs" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"function_cq_id" uuid REFERENCES aws_lambda_functions(cq_id) ON DELETE CASCADE,
	"function_arn" text,
	"arn" text,
...
CREATE TABLE IF NOT EXISTS "aws_lambda_function_version_file_system_configs" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"function_version_cq_id" uuid REFERENCES aws_lambda_function_versions(cq_id) ON DELETE CASCADE,
	"arn" text,
	"local_mount_path" text,
...
CREATE TABLE IF NOT EXISTS "aws_lambda_layer_versions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"layer_cq_id" uuid REFERENCES aws_lambda_layers(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_lambda_layer_version_policies" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"layer_version_cq_id" uuid REFERENCES aws_lambda_layer_versions(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_mq_broker_configurations" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"broker_cq_id" uuid REFERENCES aws_mq_brokers(cq_id) ON DELETE CASCADE,
	"account_id" text,
	"region" text,
	"arn" text,
	"authentication_strategy" text,
...
CREATE TABLE IF NOT EXISTS "aws_rds_cluster_parameters" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_parameter_group_cq_id" uuid REFERENCES aws_rds_cluster_parameter_groups(cq_id) ON DELETE CASCADE,
	"allowed_values" text,
	"apply_method" text,
	"apply_type" text,
	"data_type" text,
...
CREATE TABLE IF NOT EXISTS "aws_rds_cluster_associated_roles" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_cq_id" uuid REFERENCES aws_rds_clusters(cq_id) ON DELETE CASCADE,
	"feature_name" text,
	"role_arn" text,
	"status" text,
...
CREATE TABLE IF NOT EXISTS "aws_rds_db_parameters" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"db_parameter_group_cq_id" uuid REFERENCES aws_rds_db_parameter_groups(cq_id) ON DELETE CASCADE,
	"allowed_values" text,
	"apply_method" text,
	"apply_type" text,
	"data_type" text,
...
CREATE TABLE IF NOT EXISTS "aws_rds_subnet_group_subnets" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"subnet_group_cq_id" uuid REFERENCES aws_rds_subnet_groups(cq_id) ON DELETE CASCADE,
	"subnet_availability_zone_name" text,
	"subnet_identifier" text,
...
CREATE TABLE IF NOT EXISTS "aws_rds_instance_associated_roles" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"instance_cq_id" uuid REFERENCES aws_rds_instances(cq_id) ON DELETE CASCADE,
	"instance_id" text,
	"feature_name" text,
	"role_arn" text,
	"status" text,
...
CREATE TABLE IF NOT EXISTS "aws_redshift_cluster_nodes" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_cq_id" uuid REFERENCES aws_redshift_clusters(cq_id) ON DELETE CASCADE,
	"node_role" text,
	"private_ip_address" text,
	"public_ip_address" text,
...
CREATE TABLE IF NOT EXISTS "aws_redshift_cluster_parameters" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_parameter_group_cq_id" uuid REFERENCES aws_redshift_cluster_parameter_groups(cq_id) ON DELETE CASCADE,
	"allowed_values" text,
	"apply_type" text,
	"data_type" text,
	"description" text,
...
CREATE TABLE IF NOT EXISTS "aws_redshift_cluster_endpoint_vpc_endpoint_network_interfaces" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"cluster_endpoint_vpc_endpoint_cq_id" uuid REFERENCES aws_redshift_cluster_endpoint_vpc_endpoints(cq_id) ON DELETE CASCADE,
	"availability_zone" text,
	"network_interface_id" text,
	"private_ip_address" text,
	"subnet_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_redshift_subnet_group_subnets" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"subnet_group_cq_id" uuid REFERENCES aws_redshift_subnet_groups(cq_id) ON DELETE CASCADE,
	"subnet_availability_zone_name" text,
...
CREATE TABLE IF NOT EXISTS "aws_route53_domain_nameservers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"domain_cq_id" uuid REFERENCES aws_route53_domains(cq_id) ON DELETE CASCADE,
	"name" text,
	"glue_ips" text[],
...
CREATE TABLE IF NOT EXISTS "aws_route53_hosted_zone_query_logging_configs" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"hosted_zone_cq_id" uuid REFERENCES aws_route53_hosted_zones(cq_id) ON DELETE CASCADE,
	"cloud_watch_logs_log_group_arn" text,
	"id" text,
	"arn" text,
...
CREATE TABLE IF NOT EXISTS "aws_route53_traffic_policy_versions" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"traffic_policy_cq_id" uuid REFERENCES aws_route53_traffic_policies(cq_id) ON DELETE CASCADE,
	"document" jsonb,
	"id" text,
	"name" text,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_s3_bucket_grants" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"bucket_cq_id" uuid REFERENCES aws_s3_buckets(cq_id) ON DELETE CASCADE,
	"type" text,
	"display_name" text,
	"email_address" text,
	"grantee_id" text,
...
CREATE TABLE IF NOT EXISTS "aws_sagemaker_endpoint_configuration_production_variants" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"endpoint_configuration_cq_id" uuid REFERENCES aws_sagemaker_endpoint_configurations(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_sagemaker_model_containers" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"model_cq_id" uuid REFERENCES aws_sagemaker_models(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_sagemaker_training_job_algorithm_specification" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"training_job_cq_id" uuid REFERENCES aws_sagemaker_training_jobs(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_ssm_instance_compliance_items" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"instance_cq_id" uuid REFERENCES aws_ssm_instances(cq_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "aws_waf_rule_predicates" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"rule_cq_id" uuid REFERENCES aws_waf_rules(cq_id) ON DELETE CASCADE,
	"data_id" text,
	"negated" boolean,
	"type" text,
...
CREATE TABLE IF NOT EXISTS "aws_waf_web_acl_rules" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"web_acl_cq_id" uuid REFERENCES aws_waf_web_acls(cq_id) ON DELETE CASCADE,
	"priority" integer,
	"rule_id" text,
	"action_type" text,
	"excluded_rules" text[],
...
CREATE TABLE IF NOT EXISTS "aws_wafv2_web_acl_rules" (
	"cq_id" uuid NOT NULL,
	"cq_meta" jsonb,
	"web_acl_cq_id" uuid REFERENCES aws_wafv2_web_acls(cq_id) ON DELETE CASCADE,
	"name" text,
	"priority" integer,
	"statement" jsonb,
	"visibility_config_cloud_watch_metrics_enabled" boolean,
