...
ALTER TABLE IF EXISTS aws_lambda_layers ALTER COLUMN latest_matching_version_created_date TYPE TEXT USING to_char(latest_matching_version_created_date, 'YYYY-MM-DDTHH:MM:SS.MS');
