-- Autogenerated by migration tool on 2022-01-17 10:30:23
...
SELECT DEFINE_FK('aws_access_analyzer_analyzer_findings', 'analyzer_cq_id', 'aws_access_analyzer_analyzers', 'cq_id');
...
SELECT DEFINE_FK('aws_access_analyzer_analyzer_finding_sources', 'analyzer_finding_cq_id', 'aws_access_analyzer_analyzer_findings', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_domain_name_base_path_mappings', 'domain_name_cq_id', 'aws_apigateway_domain_names', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_authorizers', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_deployments', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_documentation_parts', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_documentation_versions', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_gateway_responses', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_models', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_request_validators', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_resources', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_rest_api_stages', 'rest_api_cq_id', 'aws_apigateway_rest_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_usage_plan_api_stages', 'usage_plan_cq_id', 'aws_apigateway_usage_plans', 'cq_id');
...
SELECT DEFINE_FK('aws_apigateway_usage_plan_keys', 'usage_plan_cq_id', 'aws_apigateway_usage_plans', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_authorizers', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_deployments', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_integrations', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_integration_responses', 'api_integration_cq_id', 'aws_apigatewayv2_api_integrations', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_models', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_routes', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_route_responses', 'api_route_cq_id', 'aws_apigatewayv2_api_routes', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_api_stages', 'api_cq_id', 'aws_apigatewayv2_apis', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_domain_name_configurations', 'domain_name_cq_id', 'aws_apigatewayv2_domain_names', 'cq_id');
...
SELECT DEFINE_FK('aws_apigatewayv2_domain_name_rest_api_mappings', 'domain_name_cq_id', 'aws_apigatewayv2_domain_names', 'cq_id');
...
SELECT DEFINE_FK('aws_autoscaling_group_instances', 'group_cq_id', 'aws_autoscaling_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_autoscaling_group_tags', 'group_cq_id', 'aws_autoscaling_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_autoscaling_group_scaling_policies', 'group_cq_id', 'aws_autoscaling_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_autoscaling_group_lifecycle_hooks', 'group_cq_id', 'aws_autoscaling_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_autoscaling_launch_configuration_block_device_mappings', 'launch_configuration_cq_id', 'aws_autoscaling_launch_configurations', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_default_cache_behavior_functions', 'distribution_cq_id', 'aws_cloudfront_distributions', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_origins', 'distribution_cq_id', 'aws_cloudfront_distributions', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_cache_behaviors', 'distribution_cq_id', 'aws_cloudfront_distributions', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_cache_behavior_lambda_functions', 'distribution_cache_behavior_cq_id', 'aws_cloudfront_distribution_cache_behaviors', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_custom_error_responses', 'distribution_cq_id', 'aws_cloudfront_distributions', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudfront_distribution_origin_groups', 'distribution_cq_id', 'aws_cloudfront_distributions', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudtrail_trail_event_selectors', 'trail_cq_id', 'aws_cloudtrail_trails', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudwatch_alarm_metrics', 'alarm_cq_id', 'aws_cloudwatch_alarms', 'cq_id');
...
SELECT DEFINE_FK('aws_cloudwatchlogs_filter_metric_transformations', 'filter_cq_id', 'aws_cloudwatchlogs_filters', 'cq_id');
...
SELECT DEFINE_FK('aws_codebuild_project_environment_variables', 'project_cq_id', 'aws_codebuild_projects', 'cq_id');
...
SELECT DEFINE_FK('aws_codebuild_project_file_system_locations', 'project_cq_id', 'aws_codebuild_projects', 'cq_id');
...
SELECT DEFINE_FK('aws_codebuild_project_secondary_artifacts', 'project_cq_id', 'aws_codebuild_projects', 'cq_id');
...
SELECT DEFINE_FK('aws_codebuild_project_secondary_sources', 'project_cq_id', 'aws_codebuild_projects', 'cq_id');
...
SELECT DEFINE_FK('aws_cognito_identity_pool_cognito_identity_providers', 'identity_pool_cq_id', 'aws_cognito_identity_pools', 'cq_id');
...
SELECT DEFINE_FK('aws_cognito_user_pool_schema_attributes', 'user_pool_cq_id', 'aws_cognito_user_pools', 'cq_id');
...
SELECT DEFINE_FK('aws_cognito_user_pool_identity_providers', 'user_pool_cq_id', 'aws_cognito_user_pools', 'cq_id');
...
SELECT DEFINE_FK('aws_dax_cluster_nodes', 'cluster_cq_id', 'aws_dax_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_directconnect_connection_mac_sec_keys', 'connection_cq_id', 'aws_directconnect_connections', 'cq_id');
...
SELECT DEFINE_FK('aws_directconnect_gateway_associations', 'gateway_cq_id', 'aws_directconnect_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_directconnect_gateway_attachments', 'gateway_cq_id', 'aws_directconnect_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_directconnect_lag_mac_sec_keys', 'lag_cq_id', 'aws_directconnect_lags', 'cq_id');
...
SELECT DEFINE_FK('aws_directconnect_virtual_interface_bgp_peers', 'virtual_interface_cq_id', 'aws_directconnect_virtual_interfaces', 'cq_id');
...
SELECT DEFINE_FK('aws_dms_replication_instance_replication_subnet_group_subnets', 'replication_instance_cq_id', 'aws_dms_replication_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_dms_replication_instance_vpc_security_groups', 'replication_instance_cq_id', 'aws_dms_replication_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_dynamodb_table_global_secondary_indexes', 'table_cq_id', 'aws_dynamodb_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_dynamodb_table_local_secondary_indexes', 'table_cq_id', 'aws_dynamodb_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_dynamodb_table_replicas', 'table_cq_id', 'aws_dynamodb_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_dynamodb_table_replica_auto_scalings', 'table_cq_id', 'aws_dynamodb_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_dynamodb_table_continuous_backups', 'table_cq_id', 'aws_dynamodb_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_ebs_volume_attachments', 'ebs_volume_cq_id', 'aws_ec2_ebs_volumes', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_image_block_device_mappings', 'image_cq_id', 'aws_ec2_images', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_block_device_mappings', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_elastic_gpu_associations', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_elastic_inference_accelerator_associations', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_network_interfaces', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_network_interface_groups', 'instance_network_interface_cq_id', 'aws_ec2_instance_network_interfaces', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_network_interface_ipv6_addresses', 'instance_network_interface_cq_id', 'aws_ec2_instance_network_interfaces', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_network_interface_private_ip_addresses', 'instance_network_interface_cq_id', 'aws_ec2_instance_network_interfaces', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_product_codes', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_instance_security_groups', 'instance_cq_id', 'aws_ec2_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_internet_gateway_attachments', 'internet_gateway_cq_id', 'aws_ec2_internet_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_nat_gateway_addresses', 'nat_gateway_cq_id', 'aws_ec2_nat_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_network_acl_associations', 'network_acl_cq_id', 'aws_ec2_network_acls', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_network_acl_entries', 'network_acl_cq_id', 'aws_ec2_network_acls', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_route_table_associations', 'route_table_cq_id', 'aws_ec2_route_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_route_table_propagating_vgws', 'route_table_cq_id', 'aws_ec2_route_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_route_table_routes', 'route_table_cq_id', 'aws_ec2_route_tables', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_security_group_ip_permissions', 'security_group_cq_id', 'aws_ec2_security_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_security_group_ip_permission_ip_ranges', 'security_group_ip_permission_cq_id', 'aws_ec2_security_group_ip_permissions', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_security_group_ip_permission_prefix_list_ids', 'security_group_ip_permission_cq_id', 'aws_ec2_security_group_ip_permissions', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_security_group_ip_permission_user_id_group_pairs', 'security_group_ip_permission_cq_id', 'aws_ec2_security_group_ip_permissions', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_subnet_ipv6_cidr_block_association_sets', 'subnet_cq_id', 'aws_ec2_subnets', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_transit_gateway_attachments', 'transit_gateway_cq_id', 'aws_ec2_transit_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_transit_gateway_route_tables', 'transit_gateway_cq_id', 'aws_ec2_transit_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_transit_gateway_vpc_attachments', 'transit_gateway_cq_id', 'aws_ec2_transit_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_transit_gateway_peering_attachments', 'transit_gateway_cq_id', 'aws_ec2_transit_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_transit_gateway_multicast_domains', 'transit_gateway_cq_id', 'aws_ec2_transit_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_vpc_endpoint_dns_entries', 'vpc_endpoint_cq_id', 'aws_ec2_vpc_endpoints', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_vpc_endpoint_groups', 'vpc_endpoint_cq_id', 'aws_ec2_vpc_endpoints', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_vpc_cidr_block_association_sets', 'vpc_cq_id', 'aws_ec2_vpcs', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_vpc_ipv6_cidr_block_association_sets', 'vpc_cq_id', 'aws_ec2_vpcs', 'cq_id');
...
SELECT DEFINE_FK('aws_ec2_vpc_attachment', 'vpn_gateway_cq_id', 'aws_ec2_vpn_gateways', 'cq_id');
...
SELECT DEFINE_FK('aws_ecr_repository_images', 'repository_cq_id', 'aws_ecr_repositories', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_attachments', 'cluster_cq_id', 'aws_ecs_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_services', 'cluster_cq_id', 'aws_ecs_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_deployments', 'cluster_service_cq_id', 'aws_ecs_cluster_services', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_events', 'cluster_service_cq_id', 'aws_ecs_cluster_services', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_load_balancers', 'cluster_service_cq_id', 'aws_ecs_cluster_services', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_service_registries', 'cluster_service_cq_id', 'aws_ecs_cluster_services', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_task_sets', 'cluster_service_cq_id', 'aws_ecs_cluster_services', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_task_set_load_balancers', 'cluster_service_task_set_cq_id', 'aws_ecs_cluster_service_task_sets', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_service_task_set_service_registries', 'cluster_service_task_set_cq_id', 'aws_ecs_cluster_service_task_sets', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_container_instances', 'cluster_cq_id', 'aws_ecs_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_container_instance_attachments', 'cluster_container_instance_cq_id', 'aws_ecs_cluster_container_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_container_instance_attributes', 'cluster_container_instance_cq_id', 'aws_ecs_cluster_container_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_container_instance_registered_resources', 'cluster_container_instance_cq_id', 'aws_ecs_cluster_container_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_cluster_container_instance_remaining_resources', 'cluster_container_instance_cq_id', 'aws_ecs_cluster_container_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_task_definition_container_definitions', 'task_definition_cq_id', 'aws_ecs_task_definitions', 'cq_id');
...
SELECT DEFINE_FK('aws_ecs_task_definition_volumes', 'task_definition_cq_id', 'aws_ecs_task_definitions', 'cq_id');
...
SELECT DEFINE_FK('aws_eks_cluster_encryption_configs', 'cluster_cq_id', 'aws_eks_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_eks_cluster_loggings', 'cluster_cq_id', 'aws_eks_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_elasticbeanstalk_configuration_settings', 'environment_cq_id', 'aws_elasticbeanstalk_environments', 'cq_id');
...
SELECT DEFINE_FK('aws_elasticbeanstalk_configuration_setting_options', 'configuration_setting_cq_id', 'aws_elasticbeanstalk_configuration_settings', 'cq_id');
...
SELECT DEFINE_FK('aws_elasticbeanstalk_configuration_options', 'environment_cq_id', 'aws_elasticbeanstalk_environments', 'cq_id');
...
SELECT DEFINE_FK('aws_elasticbeanstalk_environment_links', 'environment_cq_id', 'aws_elasticbeanstalk_environments', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv1_load_balancer_backend_server_descriptions', 'load_balancer_cq_id', 'aws_elbv1_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv1_load_balancer_listeners', 'load_balancer_cq_id', 'aws_elbv1_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv1_load_balancer_policies_app_cookie_stickiness', 'load_balancer_cq_id', 'aws_elbv1_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv1_load_balancer_policies_lb_cookie_stickiness', 'load_balancer_cq_id', 'aws_elbv1_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv1_load_balancer_policies', 'load_balancer_cq_id', 'aws_elbv1_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_listeners', 'load_balancer_cq_id', 'aws_elbv2_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_listener_certificates', 'listener_cq_id', 'aws_elbv2_listeners', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_listener_default_actions', 'listener_cq_id', 'aws_elbv2_listeners', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_listener_default_action_forward_config_target_groups', 'listener_default_action_cq_id', 'aws_elbv2_listener_default_actions', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_load_balancer_availability_zones', 'load_balancer_cq_id', 'aws_elbv2_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_load_balancer_availability_zone_addresses', 'load_balancer_availability_zone_cq_id', 'aws_elbv2_load_balancer_availability_zones', 'cq_id');
...
SELECT DEFINE_FK('aws_elbv2_load_balancer_attributes', 'load_balancer_cq_id', 'aws_elbv2_load_balancers', 'cq_id');
...
SELECT DEFINE_FK('aws_emr_block_public_access_config_port_ranges', 'block_public_access_config_cq_id', 'aws_emr_block_public_access_configs', 'cq_id');
...
SELECT DEFINE_FK('aws_guardduty_detector_members', 'detector_cq_id', 'aws_guardduty_detectors', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_group_policies', 'group_cq_id', 'aws_iam_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_policy_versions', 'policy_cq_id', 'aws_iam_policies', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_role_policies', 'role_cq_id', 'aws_iam_roles', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_user_access_keys', 'user_cq_id', 'aws_iam_users', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_user_groups', 'user_cq_id', 'aws_iam_users', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_user_attached_policies', 'user_cq_id', 'aws_iam_users', 'cq_id');
...
SELECT DEFINE_FK('aws_iam_user_policies', 'user_cq_id', 'aws_iam_users', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_file_system_configs', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_layers', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_aliases', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_event_invoke_configs', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_versions', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_version_file_system_configs', 'function_version_cq_id', 'aws_lambda_function_versions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_version_layers', 'function_version_cq_id', 'aws_lambda_function_versions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_concurrency_configs', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_function_event_source_mappings', 'function_cq_id', 'aws_lambda_functions', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_layer_versions', 'layer_cq_id', 'aws_lambda_layers', 'cq_id');
...
SELECT DEFINE_FK('aws_lambda_layer_version_policies', 'layer_version_cq_id', 'aws_lambda_layer_versions', 'cq_id');
...
SELECT DEFINE_FK('aws_mq_broker_configurations', 'broker_cq_id', 'aws_mq_brokers', 'cq_id');
...
SELECT DEFINE_FK('aws_mq_broker_users', 'broker_cq_id', 'aws_mq_brokers', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_cluster_parameters', 'cluster_parameter_group_cq_id', 'aws_rds_cluster_parameter_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_cluster_associated_roles', 'cluster_cq_id', 'aws_rds_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_cluster_db_cluster_members', 'cluster_cq_id', 'aws_rds_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_cluster_domain_memberships', 'cluster_cq_id', 'aws_rds_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_cluster_vpc_security_groups', 'cluster_cq_id', 'aws_rds_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_db_parameters', 'db_parameter_group_cq_id', 'aws_rds_db_parameter_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_subnet_group_subnets', 'subnet_group_cq_id', 'aws_rds_subnet_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_associated_roles', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_db_instance_automated_backups_replications', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_db_parameter_groups', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_db_security_groups', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_db_subnet_group_subnets', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_domain_memberships', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_option_group_memberships', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_rds_instance_vpc_security_groups', 'instance_cq_id', 'aws_rds_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_nodes', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_parameter_groups', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_parameters', 'cluster_parameter_group_cq_id', 'aws_redshift_cluster_parameter_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_parameter_group_status_lists', 'cluster_parameter_group_cq_id', 'aws_redshift_cluster_parameter_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_security_groups', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_deferred_maintenance_windows', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_endpoint_vpc_endpoints', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_endpoint_vpc_endpoint_network_interfaces', 'cluster_endpoint_vpc_endpoint_cq_id', 'aws_redshift_cluster_endpoint_vpc_endpoints', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_iam_roles', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_cluster_vpc_security_groups', 'cluster_cq_id', 'aws_redshift_clusters', 'cq_id');
...
SELECT DEFINE_FK('aws_redshift_subnet_group_subnets', 'subnet_group_cq_id', 'aws_redshift_subnet_groups', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_domain_nameservers', 'domain_cq_id', 'aws_route53_domains', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_hosted_zone_query_logging_configs', 'hosted_zone_cq_id', 'aws_route53_hosted_zones', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_hosted_zone_resource_record_sets', 'hosted_zone_cq_id', 'aws_route53_hosted_zones', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_hosted_zone_traffic_policy_instances', 'hosted_zone_cq_id', 'aws_route53_hosted_zones', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_hosted_zone_vpc_association_authorizations', 'hosted_zone_cq_id', 'aws_route53_hosted_zones', 'cq_id');
...
SELECT DEFINE_FK('aws_route53_traffic_policy_versions', 'traffic_policy_cq_id', 'aws_route53_traffic_policies', 'cq_id');
...
SELECT DEFINE_FK('aws_s3_bucket_grants', 'bucket_cq_id', 'aws_s3_buckets', 'cq_id');
...
SELECT DEFINE_FK('aws_s3_bucket_cors_rules', 'bucket_cq_id', 'aws_s3_buckets', 'cq_id');
...
SELECT DEFINE_FK('aws_s3_bucket_encryption_rules', 'bucket_cq_id', 'aws_s3_buckets', 'cq_id');
...
SELECT DEFINE_FK('aws_s3_bucket_replication_rules', 'bucket_cq_id', 'aws_s3_buckets', 'cq_id');
...
SELECT DEFINE_FK('aws_s3_bucket_lifecycles', 'bucket_cq_id', 'aws_s3_buckets', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_endpoint_configuration_production_variants', 'endpoint_configuration_cq_id', 'aws_sagemaker_endpoint_configurations', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_model_containers', 'model_cq_id', 'aws_sagemaker_models', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_model_vpc_config', 'model_cq_id', 'aws_sagemaker_models', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_algorithm_specification', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_debug_hook_config', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_debug_rule_configurations', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_debug_rule_evaluation_statuses', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_input_data_config', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_profiler_rule_configurations', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_sagemaker_training_job_profiler_rule_evaluation_statuses', 'training_job_cq_id', 'aws_sagemaker_training_jobs', 'cq_id');
...
SELECT DEFINE_FK('aws_ssm_instance_compliance_items', 'instance_cq_id', 'aws_ssm_instances', 'cq_id');
...
SELECT DEFINE_FK('aws_waf_rule_predicates', 'rule_cq_id', 'aws_waf_rules', 'cq_id');
...
SELECT DEFINE_FK('aws_waf_web_acl_rules', 'web_acl_cq_id', 'aws_waf_web_acls', 'cq_id');
...
SELECT DEFINE_FK('aws_wafv2_web_acl_rules', 'web_acl_cq_id', 'aws_wafv2_web_acls', 'cq_id');
...
SELECT DEFINE_FK('aws_wafv2_web_acl_post_process_firewall_manager_rule_groups', 'web_acl_cq_id', 'aws_wafv2_web_acls', 'cq_id');
...
SELECT DEFINE_FK('aws_wafv2_web_acl_pre_process_firewall_manager_rule_groups', 'web_acl_cq_id', 'aws_wafv2_web_acls', 'cq_id');
