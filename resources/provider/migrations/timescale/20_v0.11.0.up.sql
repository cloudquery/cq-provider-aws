-- Autogenerated by migration tool on 2022-01-14 17:44:48
...
COMMENT ON COLUMN aws_dms_replication_instance_replication_subnet_group_subnets.replication_instance_cq_id IS 'x-cq-fk=aws_dms_replication_instances.cq_id;';
...
COMMENT ON COLUMN aws_elbv2_listener_default_action_forward_config_target_groups.listener_default_action_cq_id IS 'x-cq-fk=aws_elbv2_listener_default_actions.cq_id;';
...
COMMENT ON COLUMN aws_redshift_cluster_endpoint_vpc_endpoint_network_interfaces.cluster_endpoint_vpc_endpoint_cq_id IS 'x-cq-fk=aws_redshift_cluster_endpoint_vpc_endpoints.cq_id;';
