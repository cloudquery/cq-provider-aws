-- Autogenerated by migration tool on 2022-01-25 17:50:38
...
CREATE TABLE IF NOT EXISTS "aws_rds_certificates" (
	...
	"customer_override_valid_until" timestamp without time zone,
	"thumbprint" text,
	"valid_from" timestamp without time zone,
	"valid_until" timestamp without time zone,
	CONSTRAINT aws_rds_certificates_pk PRIMARY KEY(cq_fetch_date,account_id,arn),
	UNIQUE(cq_fetch_date,cq_id)
);
