...
func TestRemovePII(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			"operation error EC2: DescribeSnapshotAttribute, https response error StatusCode: 400, RequestID: xxxx, api error InvalidSnapshot.NotFound: The snapshot 'snap-xxxx' does not exist.",
		},
	}
